    ...
    public class DataTests
    {
        ...
        public void TestResumenListaConMasTiposEnPortugues()
        {
            var formas = new List<FormaGeometrica>
            {
                ...
                new FormaGeometrica(FormaGeometrica.Circulo, 2.75m),
                new FormaGeometrica(FormaGeometrica.TrianguloEquilatero, 4.2m),
                new FormaGeometrica(FormaGeometrica.Trapecio, 4,4,10,5),
                new FormaGeometrica(FormaGeometrica.Trapecio, 3,4,6,4.5m),
                new FormaGeometrica(FormaGeometrica.Rectangulo, 2,0,2),
                new FormaGeometrica(FormaGeometrica.Rectangulo, 1.5m,0,2.5m),
            };

            var resumen = FormaGeometrica.Imprimir(formas, FormaGeometrica.Portugues);

            Assert.AreEqual(
                "<h1>Relatório de formulários</h1>2 Quadrados | Área 29 | Perímetro 28 <br/>2 Círculos | Área 13,01 | Perímetro 18,06 <br/>3 Triângulos | Área 49,64 | Perímetro 51,6 <br/>2 Trapézio | Área 46 | Perímetro 42 <br/>2 Retângulos | Área 7,75 | Perímetro 16 <br/>TOTAL:<br/>11 formas Perímetro 155,66 Area 145,4",
                resumen);
        }
